              ...
              <form onSubmit={handleSaveTable} style={styles.form}>
                ...
                <div style={styles.formBtnGroup}>
                  ...
                  <button type="submit" style={styles.saveBtn} disabled={loading}>
                    {loading ? 'Saving...' : (editingTableId ? 'Update Table' : 'Add Table')}
                  </button>
                </div>
              </form>
            </div>
              ...
              <div style={styles.panel} className="glass">
                ...
                <form onSubmit={handleSaveMenuItem} style={styles.form}>
                  ...
                  <div style={styles.formBtnGroup}>
                    ...
                    <button type="submit" style={styles.saveBtn} disabled={loading}>
                      {loading ? 'Saving...' : (editingMenuItemId ? 'Update Item' : 'Add Menu Item')}
                    </button>
                  </div>
                </form>
              </div>
            ...
            <div style={styles.panel} className="glass">
              ...
              <form onSubmit={handleSaveStaff} style={styles.form}>
                ...
                <div style={styles.formBtnGroup}>
                  ...
                  <button type="submit" style={styles.saveBtn} disabled={loading}>
                    {loading ? 'Saving...' : (editingStaffId ? 'Update Credentials' : 'Create Staff Member')}
                  </button>
                </div>
              </form>
            </div>
